...
##-- Model fitting --##
# method 1 - MPS
# fit <- stan(file = "src/stan/model3_4_31Oct23/model3-lambdaCst-EK.stan", data = CA6_dat, chains = 4, init = init_ll,  warmup = 3000, 
#                   iter = 10000, refresh = 5000, 
#                   control = list(adapt_delta = 0.9999, max_treedepth = 25))

fit <- stan(file = "src/stan/model3_4_31Oct23/model3-lambdaCst-EK.stan", data = CA6_dat, chains = 4, init = "random",  warmup = 3000, 
            iter = 10000, refresh = 5000, 
            control = list(adapt_delta = 0.9999, max_treedepth = 25))
 
saveRDS(fit, file = "results/model3_4_31Oct23/fit_CA6_model3_lambdaCst-31Oct23.rds")
...
sink('results/CVA6/model3/waic_CA6_m3.txt'); print(waic_m3); sink()
...
sink('results/CVA6/model3/loo_CA6_m3.txt'); print(loo_fit); sink()
...
saveRDS(fit.summary, file = "results/CVA6/model3/fitSummary_CA6_model3.rds")
write.csv(fit.summary, file = "results/CVA6/model3/fitSummary_CA6_model3.csv")
