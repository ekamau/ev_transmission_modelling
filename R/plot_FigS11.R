...
plot_fig_S11 <- function() {
  ...
  # Model fit data:
  fitCA6 <- process_cva6_fit_summary("results/CVA6/model1/fitSummary_CVA6_model1.csv")
  ...
  # Model fit data:
  fitE71 <- process_eva71_fit_summary("results/EVA71/model1/fitSummary_EVA71_model1.csv")
  ...
  figS11 <- a / b 
  ggsave(filename = 'results/figures/FigureS13.pdf', figS11, height = 150, width = 183, units = 'mm', dpi = 300)
