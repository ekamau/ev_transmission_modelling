...
fit <- stan(
  file = "src/stan/model5_exponential10.stan", data = CA6_dat, chains = 4, 
  init = "random",  warmup = 3000, iter = 10000, refresh = 5000, 
  control = list(adapt_delta = 0.9999, max_treedepth = 25))

saveRDS(fit, file = "results/CVA6/model5/CA6_model5_fit-exp10.rds")
...
sink('results/CVA6/model5/waic_CA6_m5-exp10.txt'); print(waic_m5); sink()
...
sink('results/CVA6/model5/loo_CA6_m5-exp10.txt'); print(loo_fit); sink()
