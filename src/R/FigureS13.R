...
plot_fig_S13 <- function() {
  ...
  # Model fit data:
  fitCA6 <- process_cva6_fit_summary("results/CVA6/fitSummary_CVA6_model1.csv")
  ...
  # Model fit data:
  fitE71 <- process_eva71_fit_summary("results/EVA71/fitSummary_EVA71_model1.csv")
  ...
  figS13 <- a / b 
  ggsave(filename = 'figures/FigureS13.pdf', figS13, height = 150, width = 183, units = 'mm', dpi = 300)
