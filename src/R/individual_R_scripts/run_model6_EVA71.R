...
fit <- stan(
  file = "src/stan/model6.stan", data = E71_dat, chains = 4, 
...
saveRDS(fit.summary, file = "results/fitSummary_EVA71_model6.rds")
write.csv(fit.summary, file = "results/fitSummary_EVA71_model6.csv")
