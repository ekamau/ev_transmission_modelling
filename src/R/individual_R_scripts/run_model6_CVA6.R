...
fit <- stan(
  file = "src/stan/model6.stan", data = CA6_dat, chains = 4, 
...
saveRDS(fit.summary, file = "results/fitSummary_CVA6_model6.rds")
write.csv(fit.summary, file = "results/fitSummary_CVA6_model6.csv")
